...
function References () {
  ...
  return (
      <header class={styles.header}>
        ...
        <div class="text-lg">
        1. <a href="https://pubmed.ncbi.nlm.nih.gov/29661412/">Eleveld DJ, Colin P, Absalom AR, Struys M. Pharmacokinetic-pharmacodynamic model for propofol for broad application in anaesthesia and sedation. Br J Anaesth. 2018;120(5):942-59.</a>
        </div>
        ...
        2. <a href="https://pubmed.ncbi.nlm.nih.gov/33317804/">Vellinga R, Hannivoort LN, Introna M, Touw DJ, Absalom AR, Eleveld DJ, et al. Prospective clinical validation of the Eleveld propofol pharmacokinetic-pharmacodynamic model in general anaesthesia. Br J Anaesth. 2021;126(2):386-94.</a>
        </div>
        <div class="text-sm mb-10 mt-5">
